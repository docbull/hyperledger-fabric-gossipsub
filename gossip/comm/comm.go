...
type Comm interface {
	...
	// SendGossipSub sends a block data to remote peers using libp2p GossipSub,
	// and this function will be called for block dissemination only
	SendGossipSub(msg *protoext.SignedGossipMessage, peers ...*RemotePeer)
